                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input admin-management-page-checkbox" type="checkbox"
                                                        id="isActiveStatus_{{ $specialDate->id }}"
                                                        name="isActiveStatus_{{ $specialDate->id }}"
                                                        onclick="changeActiveStatus({{ $specialDate->id }})"
                                                        @if ($specialDate->is_active == 1) checked @endif>
                                                </div>
                                            </td>
                                            <td class="text-sm">
...
@push('custom_scripts')
    <script>
        ...
        function changeActiveStatus(id) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('update.special.date.status') }}",
                data: {
                    "_token": "{{ csrf_token() }}",
                    id: id,
                    status: status,
