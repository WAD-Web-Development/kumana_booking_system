            ...
            <div class="col-12">
                <div class="card admin-management-page-card">
                    <div class="card-header px-4 py-3 d-flex justify-content-between align-items-center admin-management-page-card-header">
                        <h5 class="admin-management-page-card-title mb-0">Create Welcome Slider</h5>
                    </div>
                    <div class="card-body admin-management-page-card-body px-4 py-4">
                        <form action="{{ route('welcome-slider.store') }}" method="POST" id="welcome-slider-form" enctype="multipart/form-data">
                        @csrf
                            <div class="row gx-3">
                                <div class="col-12">
                            ...
                            <div class="row mt-4">
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="submit" class="admin-management-page-card-submit-btn px-3">Create Welcome Slider</button>
                                </div>
                            </div>
                        </form>
                    </div>
