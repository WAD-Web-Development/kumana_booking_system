                            ...
                            <div class="row gx-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="row input-group admin-management-page-card-input-row">
                                        ...
                                        <input type="number" class="col-8 form-control admin-management-page-card-input-value" aria-label="room_count" id="room_count" name="room_count"  min="1" placeholder="Enter count">
                                    </div>
                                    @error('room_count')
                                        <div class="invalid-feedback d-flex align-items-center mt-1 px-3 py-2" role="alert">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="row gx-3 mt-3">
                                <div class="col-12 col-md-6">
                                    <div class="row input-group admin-management-page-card-input-row">
                                        ...
                                        <input type="number" class="col-8 form-control admin-management-page-card-input-value" aria-label="max_people_count" id="max_people_count" name="max_people_count" min="1" placeholder="Enter count">
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="row input-group admin-management-page-card-input-row">
                                        ...
                                        <input type="number" class="col-8 form-control admin-management-page-card-input-value" aria-label="price" id="price" name="price" step="0.01" min="0" placeholder="Enter price">
                                    </div>
                                    @error('price')
                                        <div class="invalid-feedback d-flex align-items-center mt-1 px-3 py-2" role="alert">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
