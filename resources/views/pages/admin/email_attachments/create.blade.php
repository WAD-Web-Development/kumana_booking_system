...
<div class="container-fluid admin-container d-flex justify-content-center">
    ...
    <div class="card admin-card shadow-lg col-md-6 mb-5">
        <div class="card-header bg-white border-0 p-4 pb-1">
            <div class="d-lg-flex">
                <div>
                    <h5 class="mb-0 admin-title">New Email Attachment</h5>
                </div>
            </div>
        </div>
        <div class="card-body mt-2 p-4 pt-1">
            <form action="{{ route('email-attachment.store') }}" method="POST" id="email-attachment-form" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn admin-btn m-0 ms-2">Create Email Attachment</button>
                </div>
            </form>
        </div>
    </div>
...
@push('custom_scripts')
{!! JsValidator::formRequest('App\Http\Requests\StoreEmailAttachmentRequest', '#email-attachment-form') !!}
@endpush
