            ...
            <div class="col-12">
                <div class="card admin-management-page-card">
                    <div class="card-header px-4 py-3 d-flex justify-content-between align-items-center admin-management-page-card-header">
                        <h5 class="admin-management-page-card-title mb-0">Create Include</h5>
                    </div>
                    <div class="card-body admin-management-page-card-body px-4 py-4">
                        <form action="{{ route('include.store') }}" method="POST" id="include-form" enctype="multipart/form-data">
                        @csrf
                            <div class="row gx-3">
                                <div class="col-12">
                            ...
                            <div class="row mt-4">
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="submit" class="admin-management-page-card-submit-btn px-3">Create Include</button>
                                </div>
                            </div>
                        </form>
                    </div>
